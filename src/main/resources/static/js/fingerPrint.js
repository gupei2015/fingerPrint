...
function Verify(reader, captureResult)
{
    ...
    if (showScore){
        alert("captureResult score:" + captureResult.Score)
        alert("captureResult quality:" + captureResult.Quality)
        alert("captureResult result code:" + captureResult.ResultCode)
        return;
    }
    //switch (verifyState) {
    //    case 0:
       ...
       //     verifyState = 1;
        ...
        //    alert("Dissimilarity score = " + compareResult.Score + matchResult);
        //    alert("Place a finger on the reader then remove it.  ");
        //
        //    verifyState = 0;
        //    break;
        //default:
